...
//import images
import WomnImg from '../img/contact/woman.png'
      ...
      lg:text-left'>
        ...
        <div 
         ...
         className='lg:flex-1 lg:pt-32 px-4'>
          ...
          <p className='mb-12'>I would love to get suggetions from you.</p>
          {/*form*/}
          <form className='flex flex-col gap-y-14' >
            <div className='flex gap-x-10'>
              <input className='outline-none border-b
               ...
               w-full pl-3 placeholder:text-[#767879]' 
               type='text'
             ...
             <input className='outline-none border-b
               ...
               placeholder='Your message' 
                />
                <button className='btn mb-[30px] 
                mx-auto lg:mx-0 self-start '>Send it</button>
          </form>
        </div>
        {/* image */}
        <motion.div 
